	...
	function create_fragment(ctx) {
	  ...
	  var block = {
	    c: function create() {
	      ...
	      div0 = element("div");
	      h1 = element("h1");
	      h1.textContent = "Hello Svelte in ie11";
	      add_location(h1, file, 11, 8, 137);
	      attr_dev(div0, "class", "col");
	      add_location(div0, file, 10, 6, 110);
	      attr_dev(div1, "class", "row");
	      add_location(div1, file, 9, 4, 85);
	      attr_dev(div2, "class", "container");
	      add_location(div2, file, 8, 2, 56);
	      add_location(main, file, 6, 0, 44);
	    },
